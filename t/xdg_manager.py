...
eq_ok("/tmp/.local/share/test", xdg_data_home("test"), "data home path found")
eq_ok("/tmp/.config/test", xdg_config_home("test"), "config home path found")
eq_ok("/tmp/.cache/test", xdg_cache_home("test"), "cache home path found")
